    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
      ...
      {{-- ================= TOP MANAJEMEN MENU ================= --}}
        @if(auth()->user()->ROLE === 'Top Manajemen')
            ...
            {{-- --- MENU MONITORING PENGGUNAAN MATERIAL --- --}}
            <a href="{{ route('manajemen.monitoring-penggunaan') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group mb-1
               {{ request()->routeIs('manajemen.monitoring-penggunaan') 
                  ? 'bg-purple-600 text-white shadow-lg shadow-purple-900/40 translate-x-1' 
                  : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('manajemen.monitoring-penggunaan') ? 'text-white' : 'text-gray-500 group-hover:text-purple-400' }} transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                <span class="font-medium text-sm">Monitoring Material</span>
            </a>
